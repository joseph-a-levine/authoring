...
The "another" in the title is her then-husband, referred to as U.C.{% sidenote "uc" "Unnamed Companion" %} throughout the book, Ernest Hemingway. The book is enjoyable, skimmable, and witty. Maybe too witty. The marriage was entirely based on banter. On seeing another American on a train in Guandong during the Chinese Civil War:

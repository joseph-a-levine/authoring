...
{% newthought "We're hiring! Me and my co-PIs" %} are hiring a [research coordinator](https://www.povertyactionlab.org/careers/research-coordinator-university-essex-job-104861) to run an RCT in The Gambia. 

I've had a job like this — I worked in Sierra Leone for for a year on RCTs run by European and American academics. I wasn't great at this job, but I learned dense and useful lessons about how development research is produced — lessons which have been useful as I've become more involved with designing and organizing such projects.

Of course, the implicit deal here is that, in addition to learning how development research works, you'll get letters of recommendation for doctoral programs. My reference (as a second year PhD student) is worthless, but my coauthors Victor and Justine h
...
Her writing reminds me of no one so much as Matt Levine. I don't care about [the crash of two seaplanes in Alaska](https://admiralcloudberg.medium.com/warnings-unheard-warnings-unheeded-the-story-of-the-2019-alaska-mid-air-collision-89a3444fe7d7) any more or less than I care about LATEST MONEY STUFF COLUMN. But both try to make clear vital, complex, and often opaque systems which people trust implicitly. High finance and air travel both function perfectly to four nines, and fail softly to another two nines, but the insights come from looking at the tail where the system breaks down. 

The most interesting lesson I learned from Cloudberg was about the portability of complex systems. Air travel is so safe because it's so complex. It's also international — planes cross borders, so the system most work as well in Russia as it does in Antarctica as it does in Texas as it does over the Indian Ocean. 

Take collision avoidance. From the dawn of American airliners to to the 1970s, American passenger planes collided mid-air on average once every 18 months. Today, collisions still happen, but they have become much rarer. First, computers plot routes more precisely, placing airliners at different altitudes and paths before they ever take off. Then, the same computers and modern radar can warn controllers if any planes may come close to each other. And then, as an ultimate backup if controllers fail, modern jets have traffic collision avoidance systems (TCAS, pronounced tee-cas), which warns pilots of impending collisions, by directing the two planes away from each other. 
...
The [Nigerian mace heist](https://edition.cnn.com/2018/04/18/africa/nigeria-parliament-chaos/index.html)

The US did a great job eradicating malaria. But some of these problems were [self-inflicted](https://www.jstor.org/stable/24550628)
> However, the TVA developed their anti-mal programs because they created lakes suitable for mosquito breeding. [...] I find that the net effect of the TVA was to increase malaria rates following its construction. Using statistical life value estimates, 1 find that the hidden malaria cost of the TVA offset 24 percent of the fiscal stimulus multiplier generated by the TVA.

collection of graffitti from the [[1968]] protests in [[Paris]] [link](https://www.bopsecrets.org/CF/graffiti.htm)
...
why has no one told me there was a c.1st century CE parody of the [[Iliad]] about a war between mice and frogs, watched by the gods? [[Homer]]
https://sacred-texts.com/cla/homer/frogmice.htm
https://en.wikipedia.org/wiki/Batrachomyomachia

huge progress on lead: 
Samathan Power at [[USAID]] makes a [[lead]] announchement [link](https://www.cgdev.org/blog/us-government-wants-make-world-lead-free-why-thats-big-deal-and-how-we-can-make-it-happen?utm_medium=cgd_email)

i want to find out more about this bbc announcer from the early 1930s but "david tennant bbc" is ungoogleable [link](https://www.lrb.co.uk/the-paper/v46/n02/rosemary-hill/talking-about-manure)
{% maincolumn "assets/img/tennant.png" "" %}

[link](https://bayesshammai.substack.com/p/stanislav-petrov-quarterly-performance) [[Funny]] Stanislav Petrov Quarterly Performance Review

I'm sure everyone else knows about glenn burke who is known for a) being gay and b) inventing the high five with dusty baker [link](https://en.wikipedia.org/wiki/Glenn_Burke)

[link](https://lareviewofbooks.org/article/the-failed-saint-on-george-orwells-india/) Can anyone find me the Jaarj Arwal essay?

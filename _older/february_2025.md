...
There are three new posts on my blog this month: a history of [Berkeley](https://jablevine.com/articles/25/berkeley); a [list of questions](https://jablevine.com/articles/25/sf-questions) I have about San Francisco; and a [semi-satirical piece](https://jablevine.com/articles/25/freedom-cities) on the proposal to build a Freedom City in the Presidio. Apparently I'm inspired to write by place. Many are the blogs which have died on the "I'm planning to post more in the coming months" hill; here I stake my flag on that hill, and we'll see how February goes. 

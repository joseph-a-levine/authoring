...
There's much more — just what I have opinions on range from *Alice* and *Wind in the Willows* to *Jude the Obscure*, *Brideshead*, and *Jill*. Oxford attracts and inspires writers, of course, but there are all too many writers whom Oxford failed (or the other way around). *Zuleika*'s creater, Max Beerbohm, left without a degree, as did Waugh. The poets Shelley and Swinburne were both rusticated, the former for contumacy in his pamphlet *The Necessity of Atheism*; the latter for publicly advocating and supporting the assassination of Napoleon III. Gibbons was trundled away from Oxford by his family after an unexpected conversion to Catholicism, and De Quincey's addiction to opium was advanced enough that he "simply gave up in the middle of [his] final examination, and left the city for ever."

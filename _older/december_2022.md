...
In M4M, the Duke of Vienna announces he's leaving the city on a "diplomatic mission to Poland",{% sidenote "dipmispol" "That's what the kids are calling it these days." %} while actually going undercover boss as a [friar](https://chicagoreader.com/news-politics/into-the-friar/). His goal is{% sidenote "goalcondu" "His reasons can be interpreted as purely mirthful or more politically motivated, but I lean towards a more pragmatic Duke." %} to observe [the effects of good government in the city](https://artsandculture.google.com/asset/effects-of-good-government-in-the-city/WAFg-CSkcQJsMw?hl=en). Specifically, he leaves Angelo — a judge known for his strictness and piety — as his deputy, with the hope that Angelo will reintroduce 

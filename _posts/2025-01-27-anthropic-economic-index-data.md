...
The result here is that, if Eloudou et al.'s measure left us surprised at how *slow* automation is going, Acemoglu{% sidenote "temz-id" "Acemoglu *does* put a timeframe on his calculations. He expects these changes to occur over the 10 year period 2024-2034." %} should be surprised at how *fast* LLMs are being adopted.
